...
-- Set cursor to yellow and character under it to black
--vim.api.nvim_set_hl(0, 'Cursor', { fg = p.gruber_darker_black, bg = p.gruber_darker_yellow })
--vim.api.nvim_set_hl(0, 'CursorLine', { bg = p.gruber_darker_bg, fg = p.gruber_darker_fg })
--vim.api.nvim_set_hl(0, 'CursorLine', { bg = p.gruber_darker_yellow, fg = p.gruber_darker_black})
...
local highlight_groups = {
  ...
  --CursorLine                                          = { bg = p.gruber_darker_yellow, fg = p.gruber_darker_black},
  CursorLineNr                                        = { fg = p.gruber_darker_yellow, bg = p.gruber_darker_bg },
  Cursor                                              = { bg = p.gruber_darker_yellow, fg = p.gruber_darker_black},
  --ICursor                                              = { fg = p.gruber_darker_black,bg = p.gruber_darker_yellow},
  --CursorIM                                              = { fg = p.gruber_darker_black,bg = p.gruber_darker_yellow},
  ...
  Comment                                             = { fg = p.gruber_darker_brown},
